...
var ASM_CONSTS = {
  122424: () => { if (document.fullscreenElement) return 1; },  
 122470: () => { return document.getElementById('canvas').width; },  
 122522: () => { return parseInt(document.getElementById('canvas').style.width); },  
 122590: () => { document.exitFullscreen(); },  
 122617: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 122690: () => { if (document.fullscreenElement) return 1; },  
 122736: () => { return document.getElementById('canvas').width; },  
 122788: () => { return screen.width; },  
 122813: () => { document.exitFullscreen(); },  
 122840: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 122973: () => { return window.innerWidth; },  
 122999: () => { return window.innerHeight; },  
 123026: () => { if (document.fullscreenElement) return 1; },  
 123072: () => { return document.getElementById('canvas').width; },  
 123124: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123192: () => { if (document.fullscreenElement) return 1; },  
 123238: () => { return document.getElementById('canvas').width; },  
 123290: () => { return screen.width; },  
 123315: () => { return window.innerWidth; },  
 123341: () => { return window.innerHeight; },  
 123368: () => { if (document.fullscreenElement) return 1; },  
 123414: () => { return document.getElementById('canvas').width; },  
 123466: () => { return screen.width; },  
 123491: () => { document.exitFullscreen(); },  
 123518: () => { if (document.fullscreenElement) return 1; },  
 123564: () => { return document.getElementById('canvas').width; },  
 123616: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123684: () => { document.exitFullscreen(); },  
 123711: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 123769: () => { return screen.width; },  
 123794: () => { return screen.height; },  
 123820: () => { return window.screenX; },  
 123847: () => { return window.screenY; },  
 123874: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 123927: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 123998: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 124055: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 124311: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 124382: () => { if (document.fullscreenElement) return 1; },  
 124428: () => { return window.innerWidth; },  
 124454: () => { return window.innerHeight; },  
 124481: () => { if (document.pointerLockElement) return 1; }
};
